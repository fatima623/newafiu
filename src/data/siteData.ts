  ...
  },
  {
    ...
    subItems: [
      ...
      { label: 'Day Care', href: '/clinical-services/daycare' },
      {
        ...
        subItems: [
          { label: 'Tumors', href: '/clinical-services/surgeries/tumors' },
          { label: 'Stone', href: '/clinical-services/surgeries/stone' },
          { label: 'Transplant', href: '/clinical-services/surgeries/transplant' },
          { label: 'Benign / Other Conditions', href: '/clinical-services/surgeries/benign-other' },
          { label: 'Inguinoscrotal / Andrology', href: '/clinical-services/surgeries/inguinoscrotal-andrology' },
        ],
      },

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Link href="/educational-resources/patient-education" className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-950 hover:shadow-xl transition-all">
              ...
              <Link href="/educational-resources/physicians" className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-950 hover:shadow-xl transition-all">
              ...
              <Link href="/educational-resources/guidelines" className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-950 hover:shadow-xl transition-all">
